...
| `permission list` | `listPermissions` | v1 | OAuth |
...
- [ ] **D5. App writes** — `app set-version`, `app update` (the self-hosted tuning surface: `executorTimeoutSecs`, `gcRowsThreshold`, `gcTimeThresholdMs`, `globalTimeoutMs`, `privateMode`). Independent of the executor fixture. *Done when:* an update round-trips through `app get`.
