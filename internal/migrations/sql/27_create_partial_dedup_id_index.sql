...
CREATE UNIQUE INDEX %[1]s IF NOT EXISTS "uq_workflow_status_dedup_id" ON %[2]s."workflow_status" ("queue_name", "deduplication_id") WHERE "deduplication_id" IS NOT NULL;
